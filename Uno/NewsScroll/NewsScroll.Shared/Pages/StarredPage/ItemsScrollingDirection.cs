                    ...
                    if (Direction == 0)
                    {
                        ...
                        if (ListView_Items.Style != TargetStyle)
                        {
                            ...
                            if (virtualScrollViewer != null)
                            {
                                ...
                                //System.Diagnostics.Debug.WriteLine("Scrolling to vertical:" + (CurrentOffset[0] + 2));
                            }
                    ...
                    else if (Direction == 1)
                    {
                        ...
                        if (ListView_Items.Style != TargetStyle)
                        {
                            ...
                            if (virtualScrollViewer != null)
                            {
                                ...
                                //System.Diagnostics.Debug.WriteLine("Scrolling to horizontal:" + (CurrentOffset[1] + 2));
                            }
