...
namespace NewsScroll
{
    public partial class ItemViewer : UserControl
    {
        ...
        private async void webview_Full_NewWindowRequested(WebView sender, WebViewNewWindowRequestedEventArgs args)
        {
            ...
            {
                args.Handled = true;
                Debug.WriteLine("Preventing new web window: " + args.Uri.AbsolutePath.ToString());
